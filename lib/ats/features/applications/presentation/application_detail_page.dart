...
class _ApplicationDetailPageState extends State<ApplicationDetailPage> with SingleTickerProviderStateMixin {
    ...
    return BlocBuilder<ApplicationsCubit, ApplicationsState>(
      builder: (context, state) {
        ...
        return Scaffold(
          ...
          body: Column(
            children: [
              _buildDetailHeader(context, "Application Profile"),
    ...
    return ListView(
      ...
      children: [
        _buildInfoCard("Candidate Identity", [
          _buildDetailRow(Icons.person, "Candidate Name", app.candidateName, const  Color(0xFF3B82F6)),
    ...
    return ListView(
      ...
      children: [
        _buildInfoCard("Experience details", [
          _buildDetailRow(Icons.history_toggle_off, "Total Experience", "${app.totalExp} Years", const  Color(0xFF3B82F6)),
    ...
    return ListView(
      ...
      children: [
        ...
        _buildInfoCard("Contact Addresses", [
          _buildDetailRow(Icons.home, "Current Address", app.privateStreet.isNotEmpty ? app.privateStreet : "Not specified", const  Color(0xFF3B82F6)),
  ...
  Widget _buildNotesTab(HrApplicant app) {
    return ListView(
      ...
      physics: const BouncingScrollPhysics(),
      children: [
        _buildCommentCard("Applicant Comments", app.applicantComments, const  Color(0xFF3B82F6)),
        const SizedBox(height: 16),
