    ...
    return Scaffold(
      ...
      body: BlocBuilder<ProfileCubit, ProfileState>(
        buildWhen: (previous, current) {
          ...
          if (current.status == ProfileStatus.initial &&
              previous.status != ProfileStatus.initial) {
            return false;
          }
          return true;
        },
                          ...
                          onTap: () {
                            ...
                            if (picData != null && picData.length > 50) {
                              try {
                                ...
                                debugPrint(
                                  'Error decoding avatar for zoom: $e',
                                );
                              }
                            }
                          },
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    _InfoLine(
                                      ...
                                      value: employee.doj != null
                                          ? employee.doj!.toString().split(
                                              ' ',
                                            )[0]
                                          : 'N/A',
                                    ),
